...
- Produce a `requirements_doc.md` using the template in `templates/`
...
- Produce sprint plans using `templates/sprint_plan.md`
...
## Output Formats
- **Project plan**: `templates/project_plan.md`
- **Sprint plan**: `templates/sprint_plan.md`
- **Requirements doc**: `templates/requirements_doc.md`
