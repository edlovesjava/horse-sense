...
Individual user stories live in [`stories/`](stories/). Each file is named `US-NNN-description.md`. Status lives in the file's YAML frontmatter and in the index table below.
