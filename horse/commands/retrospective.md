...
2. Read the relevant `${CLAUDE_PLUGIN_ROOT}/templates/sprint_plan.md`.
...
If the same issue appears in multiple retrospectives, escalate it as a risk in `${CLAUDE_PLUGIN_ROOT}/templates/project_plan.md`.
